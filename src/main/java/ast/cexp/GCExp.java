...
/**
 * Cette classe représente une expression de comparaison "plus grand" dans l'arbre de syntaxe abstraite (AST).
...
public class GCExp extends CExp {
    ...
    /**
     * Constructeur de la classe GCExp.
    ...
    /**
     * Évalue l'expression de comparaison "plus grand".
     * @param executionState L'état d'exécution actuel.
     * @return Le résultat de l'évaluation de l'expression de comparaison "plus grand".
    ...
    public Boolean eval(ExecutionStateI executionState) throws Exception {
        ...
        return r1.compareTo(r2) > 0; // Compare les deux valeurs et retourne vrai si le premier est plus grand que le deuxième
    }
}
