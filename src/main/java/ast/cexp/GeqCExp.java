...
/**
 * Cette classe représente une expression de comparaison "plus grand ou égal" dans l'arbre de syntaxe abstraite (AST).
...
public class GeqCExp extends CExp {
    ...
    /**
     * Constructeur de la classe GeqCExp.
    ...
    /**
     * Évalue l'expression de comparaison "plus grand ou égal".
     * @param executionState L'état d'exécution actuel.
     * @return Le résultat de l'évaluation de l'expression de comparaison "plus grand ou égal".
    ...
    public Boolean eval(ExecutionStateI executionState) throws Exception {
        ...
        return r1.compareTo(r2) >= 0; // Compare les deux valeurs et retourne vrai si le premier est plus grand ou égal au deuxième
    }
}
