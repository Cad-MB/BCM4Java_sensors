...
/**
 * Cette classe représente une expression de comparaison "plus petit ou égal" dans l'arbre de syntaxe abstraite (AST).
...
public class LeqCExp extends CExp {
    ...
    /**
     * Constructeur de la classe LeqCExp.
    ...
    /**
     * Évalue l'expression de comparaison "plus petit ou égal".
     * @param executionState L'état d'exécution actuel.
     * @return Le résultat de l'évaluation de l'expression de comparaison "plus petit ou égal".
    ...
    public Boolean eval(ExecutionStateI executionState) throws Exception {
        ...
        return r1.compareTo(r2) >= 0; // Compare les deux valeurs et retourne vrai si le premier est plus petit ou égal au deuxième
    }
}
